...
const Navbar = () => {
  ...
  return (
    <div>
      <div className=" flex flex-row justify-between p-4 md:px-10 px-5 ">
        <div className=" flex items-center p-2">
          <Link to="/">
            <h1 className=" font-semibold text-2xl text-brightred z-40">VitalityVault</h1>
          </Link>
        </div>
      ...
      >
        <Link
          ...
          smooth={true}
          duration={500}
          className=" bg-brightred transition-all cursor-pointer"
        >
          Home
        </Link>
        <Link
